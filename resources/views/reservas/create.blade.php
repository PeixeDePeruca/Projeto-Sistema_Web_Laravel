...
@section('title', 'Nova Reserva - Hotel Lobisomem')
...
@section('content')
    ...
    <form action="{{ route('reservas.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="quarto_id" id="quarto_id" required>
                ...
                @foreach ($quartos as $quarto)
                    <option value="{{ $quarto->id }}" {{ old('quarto_id') == $quarto->id ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="date" name="data_entrada" id="data_entrada" value="{{ old('data_entrada') }}" required>
        </div>

        <div class="form-group">
            <label for="data_saida">Data de Saída:</label><br>
            <input type="date" name="data_saida" id="data_saida" value="{{ old('data_saida') }}" required>
        </div>
